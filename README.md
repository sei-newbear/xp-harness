...
```bash
apm install sei-newbear/xp-harness#v0.15.0 --target claude
```
...
```bash
apm install sei-newbear/xp-harness#v0.15.0 --target codex
...
```bash
apm install sei-newbear/xp-harness#v0.15.0 --target cursor
```
