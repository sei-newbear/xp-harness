...
**このプロジェクトでは以下のルールで上書きする** (= project の CLAUDE.md と skill が system prompt のデフォルトより優先)。迷ったら、この明示ルールが上書きしていることを思い出す。
...
- **要件定義書 / 基本設計書のナンバリング** を依頼者との対話で使わない。これらの md は Claude 自身が context を再現するための文書で、依頼者は見ていない:
  ...
  - 良い例: 「『呼び忘れがない構造』の Done では...」「『D4 と main.instructions が矛盾する』指摘では...」
